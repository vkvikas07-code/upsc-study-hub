...
export function MyBooksPage() {
  ...
  async function updateTopicProgress(
    ...
    if (
      previousTopic.progress_percent < 100 &&
      updatedTopic.progress_percent >= 100
    ) {
      setMessage(
  ...
  async function makeCurrentTopic(
    ...
    /*
     * Clear current topic inside this book.
     */
